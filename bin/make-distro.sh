...
#tar -czvf $ROOT_PATH/distro/$SERVICE_NAME.tar.gz $SERVICE_NAME/project.clj $SERVICE_NAME/bin $SERVICE_NAME/config/caudal-config.clj $SERVICE_NAME/config/log4j2.xml $SERVICE_NAME/resources $SERVICE_NAME/security $ROOT_PATH/lib
