(ns caudal.dashboard.core
  ...
  (:require [reagent.core :as reagent]
            ...
            [caudal.dashboard.views :as views]
            [caudal.dashboard.views.rate :as rate]
            [caudal.dashboard.views.server :as server]
            [caudal.dashboard.views.doughnut :as doughnut]
            [caudal.dashboard.views.bars :as bars]
            [caudal.dashboard.config :as config]
