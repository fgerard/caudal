...
(ns caudal.io.log-feed-simulator
  (:require [clojure.java.io :as io]
            [clojure.tools.logging :as log]
            [caudal.test.simple-parser :refer [parse-cathel-msg]])
  (:import (java.net InetSocketAddress Socket)
           (java.io PrintStream BufferedOutputStream)))

;(require '[caudal.io.log-feed-simulator :as F] :reload-all)
;(F/do-it)
...
;(require '[caudal.io.log-feed-simulator :as L])
