...
(ns mx.interware.caudal.io.tailer-server
  (:require [clojure.pprint :as pp]
            [clojure.java.io :as io]
            [clojure.tools.logging :as log]
            [clojure.string :as s]
            [clojure.core.async :refer [chan >!! alts! go-loop buffer]]
            [mx.interware.caudal.util.file-util :as file-util]
            [mx.interware.caudal.streams.common :refer [start-listener line-stats]]
...
(defmethod start-listener 'mx.interware.caudal.io.tailer-server [sink config]
  "
