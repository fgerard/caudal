...
(ns mx.interware.caudal.streams.common
  (:require [clojure.pprint :as pp]
            ...
            [mx.interware.caudal.util.caudal-util :refer [create-caudal-agent rotate-file]])
...
(defn ->toucher [mutator-fn]
  ...
  (let [[_ type] (re-matches #"^mx.interware.caudal.streams.stateful\$([a-zA-Z\-\_]+)\$.*" (str mutator-fn))]
...
(defmacro using-path-with-default-streams [form]
  (using-path mx.interware.caudal.streams.stateless mx.interware.caudal.streams.stateful form))
