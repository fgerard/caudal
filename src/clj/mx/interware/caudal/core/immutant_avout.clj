...
(ns mx.interware.caudal.core.immutant-avout
  (:gen-class)
...
(comment
  ...
  (require '[mx.interware.caudal.core.immutant-avout :as IA])
  (defn im-atom [zk-client cache a-name]
    (AA/distributed-atom zk-client a-name
                         (mx.interware.caudal.core.immutant_avout.ImmutantStateContainer. cache a-name))))
